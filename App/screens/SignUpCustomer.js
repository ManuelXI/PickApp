...
import { StyleSheet, Text, View, ImageBackground, Dimensions, Image, TouchableOpacity,TextInput, } from 'react-native';
...
export default ({navigation}) => {
  ...
  return (
      <View style={styles.container}>
          ...
          <Image source={require('../assets/images/pattern.png')} style={styles.imageContainer}  ></Image>
