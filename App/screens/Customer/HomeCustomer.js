  ...
  return (
      <View style={styles.container}>
          ...
          <View style={styles.headerContainer}>
            ...
            <TouchableOpacity>
                <Image source={require('../../assets/images/list.png')} style={styles.optionsIcon} />
            </TouchableOpacity>
            

          </View>

          <ScrollView style={{flexDirection: 'row', padding: 20}}  horizontal={true}  > 
              <View style={{paddingRight: 10}}>
                  <TouchableOpacity
                    onPress={() => setCat(1)} 
                  >
                      <Image source={require('../../assets/images/RecyclableIcon.png')} style={styles.categoryIcon}  />
                  </TouchableOpacity>
                    <Text style={styles.categoryText} > Recyclable </Text>
              </View>
