        ...
        style={{ top: 60 }} >
          ...
          style={{flexDirection: 'row', alignItems: 'flex-start', paddingBottom: 15,}} >  
            <Card style={styles.card1} >  
              ...
              <TouchableOpacity >
                      <Image source={require('../../../assets/images/PaperImage.jpg')} style={styles.imageContainer}  ></Image>
            ...
            <Card style={styles.card2} >  
              ...
              <TouchableOpacity >
                      <Image source={require('../../../assets/images/PlasticBottlesImage.jpg')} style={styles.imageContainer2}  ></Image>
          ...
          style={{flexDirection: 'row', alignItems: 'flex-start', paddingBottom: 15}} >  
            ...
            <Card style={styles.card4} >  
              ...
              <TouchableOpacity >
                      <Image source={require('../../../assets/images/WoodImage.jpg')} style={styles.imageContainer2}  ></Image>
          ...
          style={{flexDirection: 'row', alignItems: 'flex-start', paddingBottom: 15}} >  
            <Card style={styles.card3} >  
              ...
              <TouchableOpacity >
                      <Image source={require('../../../assets/images/GlassImage.jpg')} style={styles.imageContainer2}  ></Image>
            ...
            <Card style={styles.card4} >  
              ...
              <TouchableOpacity >
                      <Image source={require('../../../assets/images/CeramicsImage.jpg')} style={styles.imageContainer2}  ></Image>
          ...
          style={{flexDirection: 'row', alignItems: 'flex-start', paddingBottom: 15}} >  
            <Card style={styles.card3} >  
              ...
              <TouchableOpacity >
                      <Image source={require('../../../assets/images/TextilesImage.jpg')} style={styles.imageContainer2}  ></Image>
